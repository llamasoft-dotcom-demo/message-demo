...
messageSystem = {
  ...
  createnewActiveMessageement: function(msg) {
    ...
    $('<button class="close"></button>').text('X').appendTo(newActiveMessage).on('click', function() {
  ...
  addToNotificationList: function(msg, date) {
    for (var i = 0; i < allMessages.length; i++) {
      ...
      var textWithoutX = allMessages[i].text().slice(0, (allMessages[i].text().length - 1));
      var oldMessages = $('<div class="oldMessage"></div>').html(textWithoutX + '<br>' + '<div class="date">' +
        date + '</div>');
...
function showMsg() {
  quotes = ["What we've got here is failure to communicate.", 'Go ahead, make my day.',
    "I've got a bad feeling about this.",
    "I don't know half of you half as well as I should like; and I like less than half of you half as well as you deserve.",
    'I find your lack of faith disturbing.', "You're gonna need a bigger boat.", 'Tell Mike it was only business.',
