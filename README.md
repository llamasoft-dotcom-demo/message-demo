...
# Future Enhancements
1. Messages can be strored in backend using some db framework and server side api can be used to pass data as json to front end
...
2. The idea behind this is to demonstrate real world api calls using angular http service and reuse existing code [notificationfactory/messagecontroller] to show message received from API.
